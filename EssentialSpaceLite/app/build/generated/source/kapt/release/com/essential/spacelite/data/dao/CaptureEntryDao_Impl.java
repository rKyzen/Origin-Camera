  ...
  public CaptureEntryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCaptureEntry = new EntityInsertionAdapter<CaptureEntry>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `capture_entries` (`id`,`screenshot_path`,`thumbnail_path`,`text_note`,`voice_note_path`,`voice_note_duration_ms`,`timestamp`,`reminder_at`,`ai_summary`,`app_name`,`is_favorite`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfCaptureEntry = new EntityDeletionOrUpdateAdapter<CaptureEntry>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `capture_entries` SET `id` = ?,`screenshot_path` = ?,`thumbnail_path` = ?,`text_note` = ?,`voice_note_path` = ?,`voice_note_duration_ms` = ?,`timestamp` = ?,`reminder_at` = ?,`ai_summary` = ?,`app_name` = ?,`is_favorite` = ? WHERE `id` = ?";
      }
      ...
      public List<CaptureEntry> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CaptureEntry(_tmpId,_tmpScreenshotPath,_tmpThumbnailPath,_tmpTextNote,_tmpVoiceNotePath,_tmpVoiceNoteDurationMs,_tmpTimestamp,_tmpReminderAt,_tmpAiSummary,_tmpAppName,_tmpIsFavorite);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public CaptureEntry call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsFavorite);
            _tmpIsFavorite = _tmp != 0;
            _result = new CaptureEntry(_tmpId,_tmpScreenshotPath,_tmpThumbnailPath,_tmpTextNote,_tmpVoiceNotePath,_tmpVoiceNoteDurationMs,_tmpTimestamp,_tmpReminderAt,_tmpAiSummary,_tmpAppName,_tmpIsFavorite);
          } else {
            _result = null;
          }
          return _result;
