  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `capture_entries` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `screenshot_path` TEXT NOT NULL, `thumbnail_path` TEXT NOT NULL, `text_note` TEXT, `voice_note_path` TEXT, `voice_note_duration_ms` INTEGER NOT NULL, `timestamp` INTEGER NOT NULL, `reminder_at` INTEGER, `ai_summary` TEXT, `app_name` TEXT, `is_favorite` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '4c21e2132151d4c853a956fe63e2d7c8')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsCaptureEntries = new HashMap<String, TableInfo.Column>(11);
        ...
        _columnsCaptureEntries.put("is_favorite", new TableInfo.Column("is_favorite", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "4c21e2132151d4c853a956fe63e2d7c8", "20535bd37f17774f1921f78d46afaff3");
