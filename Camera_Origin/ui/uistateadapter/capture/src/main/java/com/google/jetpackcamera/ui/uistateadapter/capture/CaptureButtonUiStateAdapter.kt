...
fun CaptureButtonUiState.Companion.from(
    ...
    val mfsInProgress = cameraState.mfsState is MfsState.Capturing ||
        cameraState.mfsState is MfsState.Merging ||
        cameraState.mfsState is MfsState.Saving

    return if (cameraState.isCameraRunning && !mfsInProgress) {
